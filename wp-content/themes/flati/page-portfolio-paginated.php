 ...
 * Template Name: Paginated Portfolio
*/
...
<div class="container wrapper">
    ...
    <div class="inner_content">
        ...
        <div class="row">
        	...
        	<ul id="itemContainer"> 
              ...
              if ( have_posts() ) : while ( have_posts() ) : the_post(); 
				...
				$thumbnail_large = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'large', false);
				
				?>
              <li>
                	<div <?php post_class('span3 morepaddingbottom'); ?> id="post-<?php the_ID(); ?>">
        ...
        <div class="holder smallerpadding"></div>
