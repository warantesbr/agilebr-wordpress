...
/***************************************************
	MENU
***************************************************/
	$("<select />").appendTo("nav.ublmenu1 div");
	...
	$("<option />", {
	   ...
	   "value"   : "",
	   "text"    : "choose a page"
	}).appendTo("nav.ublmenu1 select");	
	
	// Populate dropdowns with the first menu items
	$("nav.ublmenu1 li a").each(function() {
	 	var el = $(this);
	 	$("<option />", {
	     	"value"   : el.attr("href"),
	    	"text"    : el.text()
	...
	$("<select />").appendTo("nav.ublmenu2 div");
	...
	$("<option />", {
	   ...
	   "value"   : "",
	   "text"    : "choose a page"
	}).appendTo("nav.ublmenu2 select");	
	
	// Populate dropdowns with the first menu items
	$("nav.ublmenu2 li a").each(function() {
	 	var el = $(this);
	 	$("<option />", {
	     	"value"   : el.attr("href"),
	    	"text"    : el.text()
