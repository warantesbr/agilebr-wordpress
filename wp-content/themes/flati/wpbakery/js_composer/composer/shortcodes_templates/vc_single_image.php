...
if ( $img == NULL ) $img['thumbnail'] = '<img src="http://placekitten.com/g/400/300" /> <small>'.__('This is image placeholder, edit your page to replace it.', 'ublflati').'</small>';
...
$image_string = !empty($link_to) ? '<div class="hover_colour"><a rel="prettyPhoto[portfolio1]"'.$a_class.' href="'.$link_to.'"'.($img_link_target!='_self' ? ' target="'.$img_link_target.'"' : '').'>'.$img['thumbnail'].'</a></div>' : $img['thumbnail'];
