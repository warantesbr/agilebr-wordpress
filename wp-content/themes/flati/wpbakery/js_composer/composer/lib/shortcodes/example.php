...
vc_map( array(
    ...
    "params"	=> array(
        array(
            ...
            "holder" => "h3",
            "class" => "",
            "heading" => __("Foo attribute", "ublflati"),
            "param_name" => "foo",
            "value" => __("I'm foo attribute", "ublflati"),
            "description" => __("Enter foo value.", "ublflati")
        ),
        array(
            "type" => "textarea_html",
            "holder" => "div",
            ...
            "param_name" => "content",
            "value" => __("I'm hello world", "ublflati"),
            "description" => __("Enter your content.", "ublflati")
        ),
        array(
            "type" => "dropdown",
            "heading" => __("Drop down example", "ublflati"),
            "param_name" => "my_dropdown",
            "value" => array(1, 2, "three"),
            "description" => __("One, two or three?", "ublflati")
        ),
    )
) );
