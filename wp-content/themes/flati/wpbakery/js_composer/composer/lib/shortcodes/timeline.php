...
class WPBakeryShortCode_VC_timeline_tab extends WPBakeryShortCode_VC_Tab {
...
class WPBakeryShortCode_VC_Timeline extends WPBakeryShortCode {

    public function __construct($settings) {
        parent::__construct($settings);
        // WPBakeryVisualComposer::getInstance()->addShortCode( array( 'base' => 'vc_timeline_tab' ) );
    }
    ...
    public function contentAdmin( $atts, $content ) {
        ...
        $tmp = '';
        // $template = '<div class="wpb_template">'.do_shortcode('[vc_timeline_tab title="New Section"][/vc_timeline_tab]').'</div>';
