...
class VcTeaserTemplates {
    ...
    public function __construct() {
        $this->templates = array(
            "title_thumbnail_text" => __("Title + Thumbnail + Text", "ublflati"),
            "thumbnail_title_text" => __("Thumbnail + Title + Text", "ublflati"),
            "thumbnail_text" => __("Thumbnail + Text", "ublflati"),
            "thumbnail_title" => __("Thumbnail + Title", "ublflati"),
            "thumbnail" => __("Thumbnail only", "ublflati"),
            "title_text" =>  __("Title + Text", "ublflati"));
    }
