...
function vc_loop_form_field($settings, $value) {
    ...
    return '<div class="vc-loop">'
        ...
        .'<a href="#" class="button vc-loop-build '.$settings['param_name'].'_button" data-settings="'.rawurlencode(json_encode($settings['settings'])).'">'.__('Build query', 'ublflati').'</a>'
...
class VcLoopSettings {
    ...
    function __construct($value, $settings = array()) {
        $this->parts = array(
            'size' => __('Post Count', 'ublflati'),
            'order_by' => __('Order By', 'ublflati'),
            'order' => __('Order', 'ublflati'),
            'post_type' => __('Post types', 'ublflati'),
            'authors' => __('Author', 'ublflati'),
            'categories' => __('Categories', 'ublflati'),
            'tags' => __('Tags', 'ublflati'),
            'tax_query' => __('Taxonomies', 'ublflati'),
            'by_id' => __('Individual Posts/Pages', 'ublflati')
        );
    ...
    public function parse_order_by($value) {
        return $this->parseDropDown($value, array(
            //array('none', __("None", 'ublflati')),
            array('date', __("Date", 'ublflati')),
            'ID',
            array('author', __("Author", 'ublflati')),
            array('title', __("Title", 'ublflati')),
            //'name',
            array('modified', __("Modified", 'ublflati')),
            //'parent',
            array('rand', __("Random", 'ublflati')),
            array('comment_count', __("Comment count", 'ublflati')),
            array('menu_order', __("Menu order", 'ublflati')),
            //'meta_value',
            //'meta_value_num',
            //'post__in'
        ));
    ...
    public function parse_order($value) {
        return $this->parseDropDown($value, array(
            array('ASC', __("Ascending", 'ublflati')),
            array('DESC', __("Descending", 'ublflati'))
        ));
    }
