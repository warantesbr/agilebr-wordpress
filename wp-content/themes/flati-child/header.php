...
<body <?php body_class(); ?>>
	...
	<div id="aga_banner">
		...
		<div class="agile outer">
			...
			<div class="agile inner">
				...
				<a href="/"><img src="<?= get_stylesheet_directory_uri(); ?>/img/logo_@2x.png" alt="logo_@2x" width="160" height="116" id="logo" /></a>
    ...
    <div class="header ">
        ...
        <div class="container">
        	...
        	<!--<div class="header-nav2"><?php wp_nav_menu( array( 'theme_location' => 'top-nav-2' ) ); ?></div>-->
